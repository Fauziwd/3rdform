    ...
    <>
      ...
      >
        <h5
          ...
          class="text-base font-semibold  uppercase dark:text-white text-white"
        >
          Menu
        </h5>
        <button
        ...
        <div class="py-4 overflow-y-auto">
          <ul class="space-y-2 font-medium">
            ...
            {/* <li>
            <a href="#" class="flex items-center p-2  rounded-lg dark:text-white text-white hover:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <li>
              <button
                type="button"
                className="flex items-center w-full p-2  transition duration-75 rounded-lg group hover:bg-gray-800 dark:text-white text-white dark:hover:bg-gray-700"
              ...
              <ul id="dropdown-example" className="hidden py-2 space-y-2">
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-800 dark:text-white text-white dark:hover:bg-gray-700"
                ...
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-gray-900 hover:text-white dark:text-white text-white dark:hover:bg-gray-700"
                ...
                <hr />
                <h2 className="dark:text-white text-white">Tema Lain</h2>
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-blue-300 dark:text-white text-white dark:hover:bg-blue-500"
                ...
                <li>
                  <button
                    type="button"
                    className="flex items-center w-full p-2  transition duration-75 rounded-lg pl-11 group hover:bg-green-900 hover:text-white dark:text-white text-white dark:hover:bg-green-500"
