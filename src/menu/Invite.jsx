...
function Invite() {
  ...
  const handleSubmit = (e) => {
    ...
    // Tampilkan nilai input yang telah di-submit ke konsol sebelum mereset state
    console.log(nama);
    console.log(email);
  ...
  <input
    type="email"
    name="floating_email"
    id="floating_email" // ID harus sesuai dengan atribut "htmlFor" pada elemen label
  ...
  >
    Email address
        ...
        <div className="flex justify-left mt-4 gap-2">
          {" "}
          {/* Wadah div untuk menyusun tombol */}
          <button
            type="submit"
