...
function Galeri() {
  ...
  const images = [
    {
      url: "/image/WonkNjero/Adam/IMG_20200919_153455.jpg",
      category: "Adam",
    },
    {
    ...
    {
      url: "/image/WonkNjero/Misbah/IMG_20201223_090326.jpg",
      category: "Misbah",
    },
    {
  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="absolute top-0 mt-44 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-gray-100 font-bold text-4xl z-10 drop-shadow-lg">
          Galeri Kenangan
        </h1>
        <div className="overflow-x-auto">
          <div className="grid grid-cols-12 gap-28 p-8">
            <div className="bg-purple-200 rounded-xl h-24 w-24 shadow-lg">
              <img
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 p-4 gap-4 dark:bg-gray-800">
